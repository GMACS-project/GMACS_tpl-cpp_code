...
##--run all
if (FALSE) results = runTests(cleanup=FALSE,usePin=TRUE,compareWithPin=TRUE);
...
#--run new format
if (FALSE) results = runTests("TannerCrab_MalesOnlyANew",usePin=TRUE,compareWithPin=TRUE,cleanup=FALSE,verbose=100);
