## GMACS Version 2.20.14; ** AEP & WTS **; Compiled 2024-05-20
...
# Initial_value    Lower_bound    Upper_bound Phase Prior_type        Prior_1        Prior_2
   ...
   110.00000000   103.00000000   165.00000000    -2          1    72.50000000     7.25000000 # Recruitment_ra-males
    ...
    -0.69314718   -10.00000000     0.75000000    -1          0   -10.00000000     0.75000000 # log(SigmaR)
     ...
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 2
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 3
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 4
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 5    
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 6
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 7
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 8
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 9
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 10
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 11
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 12
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 13   
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 14
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 15
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 16
     0            -10              4              4          0     10.0           20.00      # Deviation for size-class 17
...
#  I+M  I+M 
      ...
      1      1 # Lambda for effective sample size
...
#      Initial    Lower_bound    Upper_bound  Prior_type        Prior_1        Prior_2  Phase 
    1.00000000     0.05000000    20.00000000      0     0.00000000   999.00000000     4 # Overdispersion_parameter_for_size_comp_1(possibly extended)
    1.00000000     0.05000000    20.00000000      0     0.00000000   999.00000000     4 # Overdispersion_parameter_for_size_comp_2(possibly extended)
