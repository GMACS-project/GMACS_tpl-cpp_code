...
While the file is a single entity, it is convenient to examine the different sections separately (but in the order they occur in the file).
...
```default
##  CATCH  DATA                                                        
0 #--input format for catch data (0:old format; 1: new format)                  
...
The beginning of the second catch dataframe (total catch [retained + discards] of males in the fishery labeled 'TCF') starts at (11).
...
0 #--input format for relative abundance data (0:old format; 1: new format)
...
```default
1 #--input format for relative abundance data (0:old format; 1: new format)
1 #--number of dataframes
#----
##--fleet: NMFS; index type: sel; units type: biomass; units: THOUSANDS_MT.
sel        #--index type ('sel' or 'sel+ret')
biomass    #--units type ('abundance' or 'biomass')
NMFS        #--fleet
male        #--sex (male(s), female(s), undetermined)
undetermined        #--maturity (immature, mature, undetermined)
undetermined        #--shell condition (new shell, old shell, undetermined)
41        #--number of rows in dataframe
# q_index year season value cv multiplier CPUE_timing 
...
```default
##--SIZE COMPS------------------------------------------------
0 #--input format for size comps (0:old format; 1: new format)
## Number of length frequency matrices	 																													
13																														
## Number of rows in each matrix																														
40	30	27	32	32	7	34	7	34	7	34	7	34																	
...
##	Maturity	state:	1	=	"mature,"	2	=	"immature,"	0	=	both	states	combined																	
...
```default
##--SIZE COMPS------------------------------------------------
1 #--input format for size comps (0:old format; 1: new format)
3 #--number of size comps dataframes
##--fleet: TCF; gear: crab pot; catch_type: RETAINED; units: MILLIONS.
RETAINED    #--catch type
TCF   #--fleet
male undetermined undetermined        #--sex, maturity, shell condition
...
::: {#nte-envd .callout-note title="Environmental data section of example `model.dat` file."}
